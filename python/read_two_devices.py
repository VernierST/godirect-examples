...
# Enter the sensors for multiple devices using a 2D list (e.g., [[1,2], [1]] ), where
# the first list corresponds to the sensors of the first opened device. 
...
for i in range(0,5):
    ...
    print(measurements[2], column_headers[2])   
